...
{
	internal class ObjectExplorer : IPlugin
	{
		...
		public string Description => "A plugin that provides a debug tab for objects currently in the client.";
		...
		public JsonSettings Settings => ObjectExplorerSettings.Instance;
