...
namespace ExamplePlugin
{
    public static class Flasks
    {
        public static Item LifeFlask => FlaskHud.InventoryControl.Inventory.Items
            .HighestCharge(f => (f.Class == ItemClasses.LifeFlask || f.Class == ItemClasses.HybridFlask) && !f.IsInstantRecovery);

        public static Item InstantLifeFlask => FlaskHud.InventoryControl.Inventory.Items
            .HighestCharge(f => (f.Class == ItemClasses.LifeFlask || f.Class == ItemClasses.HybridFlask) && (f.IsInstantRecovery || IsPanicked(f)));

        public static Item ManaFlask => FlaskHud.InventoryControl.Inventory.Items
            .HighestCharge(f => (f.Class == ItemClasses.ManaFlask || f.Class == ItemClasses.HybridFlask) && !f.IsInstantRecovery);
        ...
        public static bool IsPanicked(Item item) => item.FullName.StartsWith("Panicked");
        ...
        private static Rarity RarityLite(this Item item)
        {
